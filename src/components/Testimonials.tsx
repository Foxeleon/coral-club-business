...
const Testimonials = () => {
  const testimonials = [
    ...
    {
      name: "Асят Вахаева",
      text: "Этот бизнес лучше линейного: не нужно вкладывать деньги, платить за аренду, доставку и другие издержки. Здесь есть наставники, поддержка и готовые действия. \n" +
          "Быстро расти очень интересно. Оказалось, что большие суммы зарабатываются легче, чем казалось.\n",
      role: "Партнер Coral Club"
    }
  ];
