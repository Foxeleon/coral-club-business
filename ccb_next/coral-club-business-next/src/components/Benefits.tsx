  ...
  const benefits = [
    {
      icon: Globe,
      title: "Мировой бренд",
      description: "Более 25 лет на рынке оздоровительных продуктов с проверенной репутацией"
    },
    {
      icon: Heart,
      title: "Продукция для жизни",
      description: "Детокс программы, витамины, ферменты и уникальные продукты, такие, как Корал-Майн."
    },
    {
      icon: TrendingUp,
